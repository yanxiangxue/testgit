...
public class FeedH5ListViewRealTimeAdapter extends BaseAdapter implements OnClickListener {
    ...
    public FeedH5ListViewRealTimeAdapter(Context context, List<Object> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_AD) {
            ...
            final BaiduNativeH5AdView newAdView = BaiduNativeH5AdViewManager.getInstance()
                    .getBaiduNativeH5AdView(context, (BaiduNativeAdPlacement) data, R.drawable.recmd_blue_bidu);
