...
import static com.baidu.mobads.demo.main.feeds.FeedH5RecyclerViewPreloadActivity.INTERVAL;

public class FeedH5RecyclerViewPreloadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_AD = 0;
    private static final int TYPE_DATA = 1;
    private Context context;
    private List<Object> mRecyclerViewItems;

    public FeedH5RecyclerViewPreloadAdapter(Context context, List<Object> recyclerViewItems) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            case TYPE_AD:
                ...
                rl.removeAllViews();
                BaiduNativeAdPlacement placement = (BaiduNativeAdPlacement) mRecyclerViewItems.get(position);
                BaiduNativeH5AdView newAdView = BaiduNativeH5AdViewManager.getInstance().getBaiduNativeH5AdView
                        (context, placement, R.drawable.recmd_blue_bidu);
                ...
                if (placement.isAdDataLoaded()) {
                    rl.addView(newAdView, new RelativeLayout.LayoutParams(width, height));
