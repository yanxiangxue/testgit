...
public class FeedH5ChuChuangActivity extends Activity {

    private static final String TAG = "FeedH5ChuChuangActivity";
    ...
    private static String YOUR_AD_PLACE_ID = "2403623"; // 双引号中填写自己的广告位ID
        ...
        BaiduNative baidu = new BaiduNative(activity, YOUR_AD_PLACE_ID, 
                new BaiduNativeNetworkListener() {
                    ...
                    public void onNativeFail(NativeErrorCode arg0) {
                        Toast.makeText(FeedH5ChuChuangActivity.this, "没有收到橱窗模板广告，请检查", Toast.LENGTH_LONG).show();
                    }
                    ...
                    public void onNativeLoad(List<NativeResponse> arg0) {
                        if (arg0 != null && arg0.size() > 0) {
                            ...
                            if (mNrAd.getMaterialType() == MaterialType.HTML) {
                                Toast.makeText(FeedH5ChuChuangActivity.this, "收到橱窗模板广告.", Toast.LENGTH_LONG).show();

                                myHandler.sendEmptyMessage(SHOW_HTML);
                            } else {
                                Toast.makeText(FeedH5ChuChuangActivity.this,
