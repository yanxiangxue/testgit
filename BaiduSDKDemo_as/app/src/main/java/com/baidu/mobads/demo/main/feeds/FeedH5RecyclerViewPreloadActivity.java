...
public class FeedH5RecyclerViewPreloadActivity extends Activity {
    ...
    private void onAllDataReady() {
        // 可以在这里对广告进行重排序
        FeedH5RecyclerViewPreloadActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mRecyclerView = (RecyclerView) FeedH5RecyclerViewPreloadActivity.this.findViewById(R.id.recycler_view);
                mRecyclerView.setHasFixedSize(true);

                // Specify a linear layout manager.
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(FeedH5RecyclerViewPreloadActivity
                        .this);
                mRecyclerView.setLayoutManager(layoutManager);

                RecyclerView.Adapter mAdapter =
                        new FeedH5RecyclerViewPreloadAdapter(FeedH5RecyclerViewPreloadActivity.this, mList);
